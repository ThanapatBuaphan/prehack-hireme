...
export default function CreateAcc3user() {
  ...
  // ── Submit ──
  const handleCreate = () => {
    // TODO: submit { ...prevData, educations, experiences, resume } to API
    console.log("Final payload:", { ...prevData, educations, experiences, resumeFile });
    navigate("/");
  };
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-10">
      <div className="bg-white rounded-2xl shadow-md w-full max-w-lg p-8 flex flex-col items-center">
        ...
        <button
          ...
          className="mt-8 w-full flex items-center justify-center gap-2 py-3.5 rounded-xl font-semibold text-white text-base bg-[#0455E2] hover:bg-blue-700 active:scale-95 shadow-md shadow-blue-200 transition-all duration-200"
        >
          Create Account
