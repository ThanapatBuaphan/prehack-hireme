  ...
  return (
    <div className="min-h-full p-6 flex items-start justify-center">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 w-full max-w-2xl p-8">
        <h1 className="text-2xl font-bold text-gray-800">Edit Your Post</h1>
        ...
        <div className="flex justify-end gap-3">
          ...
          <button onClick={handleSave} disabled={loading}
            className="px-6 py-2.5 rounded-lg bg-[#515DB6] hover:bg-[#3D3B8E] text-white text-sm font-semibold transition-colors disabled:opacity-60">
            {loading ? "Saving..." : "Save"}
          </button>
        </div>
      </div>
