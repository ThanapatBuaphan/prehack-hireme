...
export default function CreateAcc2user() {
  ...
  const handleContinue = () => {
    ...
    navigate("/CreateAcc3user", { state: { formData: form } });
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-10">
      <div className="bg-white rounded-2xl shadow-md w-full max-w-md p-8 flex flex-col items-center">
        ...
        <p className="text-gray-500 text-sm mb-6 text-center">Fill in your details to get started.</p>
